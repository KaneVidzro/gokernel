...
func (x *TokenClaims) GetValid() bool {
	if x != nil {
		return x.Valid
	}
	return false
...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\x05valid\x18\x03 \x01(\bR\x05valid2E\n" +
	"\vAuthService\x126\n" +
	"\rValidateToken\x12\x12.auth.TokenRequest\x1a\x11.auth.TokenClaimsB0Z.github.com/kanevidzro/gokernel/proto/auth;authb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	1, // 1: auth.AuthService.ValidateToken:output_type -> auth.TokenClaims
